    ...
    <div id="contents">
        ...
        <div id="cont_left">
            <div class="information">
                <h2>INFORMATION</h2>
                <dl>
                    <?php $infoPosts = get_posts('numberposts=4&category=1,3,4'); foreach($infoPosts as $post): ?>  
            ...
            <div class="information">
                <h2>BLOG</h2>
                <dl>
                    <?php $infoPosts = get_posts('numberposts=4&category=7'); foreach($infoPosts as $post): ?>                    
                    <dt><?php the_time('Y-m-d'); ?></dt>
                    <dd>
                        <div class="b_img">
